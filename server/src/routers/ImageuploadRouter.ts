...
// TODO: separate vuforia logic to it's own router/class
export class ImageuploadRouter {
  ...
  public editor(req: Request, res: Response) {
 ...
 // public getMarkerNames(req: Request, res: Response) {
   // fs.readdir(
     // path.join(__dirname, '../../../dist/assets/images/textures/markers' /* "../../../client/public/textures/markers" */),
      //(err, files) => {
        //if (err) {
...
public getUploadImages(){
  ...
  public uploadImages(req: Request, res: Response) {
    ...
    let sentFiles: any = [];
    let sentFields: any = [];
    form.uploadDir = path.join(__dirname, '../../../dist/assets/images/textures/markers');
    // on field load
        ...
        client.addTarget(target, (err: any, result: any) => {
          if (err) {
            ...
            let destPath = path.join(
              ...
              '../../../dist/assets/images/textures/markers',
              newFileName
            );
  ...
  public routes() {
    //this.router.get("/", this.editor);
    this.router.get("/get_images", this.getUploadImages);
    this.router.post("/upload_Images", this.uploadImages);
    this.router.get("/presentation/:dataName", this.retrievePresentation);
    this.router.post("/save/scene", this.savePresentation);
  }
}

const editorRouter = new ImageuploadRouter();

export default editorRouter.router as Router;
